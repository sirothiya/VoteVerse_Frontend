  ...
  const handleAddSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `https://voteverse-backend-new.onrender.com/admin/addcandidate`,
        {
          method: "POST",
          headers: {
...
const handleEditSubmit=async(e)=>{
    ...
    try{
      ...
      const response=await fetch(`https://voteverse-backend-new.onrender.com/admin/${editId}`,{
        method:"PUT",
        headers:{
          Authorization: `Bearer ${storedToken}`,
        },
  ...
  const handleDelete = async (id) => {
    try {
      const response = await fetch(
        `https://voteverse-backend-new.onrender.com/admin/${id}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${storedToken}`,
